...
# https://skytra.atlassian.net/secure/RapidBoard.jspa?rapidView=26&projectKey=CMP&modal=detail&selectedIssue=CMP-37
...
$files='dag_BA_Trillo_Staging_daily_v5_0_2.py'
foreach ($f in $files) { 
...
Next Day
-----------------------
[] - check for expected exact 2PM BST RunDate in Airflow Dashboard
"""
