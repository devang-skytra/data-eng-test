...
CALL generic_sp.sp_exclusion_compliance_add('route',"%202101141400_ISB-KHI%",'FFD', '2020-11-09', '2999-09-09', '1999-09-09', '2999-09-09');
CALL generic_sp.sp_exclusion_compliance_add('route',"%202101140500_ISB-KHI%",'FFD', '2020-11-09', '2999-09-09', '1999-09-09', '2999-09-09');
...
Immediate
-----------------------
[] - In Airflow, take rendered SQL for X12 and run against BigQuery and confirm expected tickets excluded
"""
