...
# First, do global replace of prior file with new file, etc.
# prior file 'FinalOutput_2020-07-06_w_2020-07-12_Global.csv'
# '2020-07-06';
# '2020-07-12';
...
WHERE FILE_SOURCE = 'gs://ext-iata-excl-data/2020/unzipped/FinalOutput_2020-07-06_w_2020-07-12_Global.csv'"
...
LIMIT 20
"""
# int_X1_file_analysis 	21,305,571 - 	22,201,003

# 2 X3
DECLARE fileFull STRING DEFAULT 'FinalOutput_2020-07-06_w_2020-07-12_Global.csv';
DECLARE dS DATE DEFAULT '2020-07-06';
DECLARE dE DATE DEFAULT '2020-07-12';
