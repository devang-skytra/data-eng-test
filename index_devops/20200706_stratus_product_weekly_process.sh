...
# First, do global replace of prior file with new file
# prior file 'FinalOutput_2020-06-29_w_2020-07-05_Global.csv'
...
WHERE FILE_SOURCE = 'gs://ext-iata-excl-data/2020/unzipped/FinalOutput_2020-06-29_w_2020-07-05_Global.csv'"
...
LIMIT 20
"""
# int_X1_file_analysis 21,305,571

# 2 X3
DECLARE fileFull STRING DEFAULT 'FinalOutput_2020-06-29_w_2020-07-05_Global.csv';
DECLARE dS DATE DEFAULT '2020-06-29';
DECLARE dE DATE DEFAULT '2020-07-05';

# NB: these params are slightly different to Migrated Call
CALL `skytra-benchmark-rnd.iata_sp.sp_process_X3`(dS, dE, fileFull);
# X3 21,296,859
# metric 572
...
"WITH iata_legs AS (
  ...
  AND FILE_SOURCE = 'FinalOutput_2020-06-29_w_2020-07-05_Global.csv'
)
...
rrpk_options AS (
  ...
  WHERE r3.dt_of_issue>='2017-10-19')
...
FROM rrpk_options
"
# R5 FinalOutput_2020-06-29_w_2020-07-05_Global.csv 8978050 8978050 5323613 8978050
"""
...
WITH
  ...
  SELECT
    ...
    r5.waterfall_rrpk,
    r5.waterfall_source,
    ROUND(r5.waterfall_rrpk*r1.dist_km,2) AS leg_revenue,
    -- Transaction type
    r1.transaction_code,
    r1.od_cabin_class,
    -- FILE source
  ...
  WHERE  r1.dt_of_issue >= '2017-10-19'
    AND r5.dt_of_issue >= '2017-10-19')
SELECT
  0 AS pl_id,
  * EXCEPT(release)
FROM
