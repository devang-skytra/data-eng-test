...
gcloud composer environments update %COMPOSER_NAME% --location %COMPOSER_LOCATION% --update-pypi-packages-from-file=C:\git\DataEng\index_utils\af\sa_cmd\af_PyPi_requirements.txt
