...
filePrefix="FinalOutput_2020-04-06_w_2020-04-12_Global"
...
#-----------
fileFull="FinalOutput_2020-04-06_w_2020-04-12_Global.csv"
...
where _FILE_NAME like '%FinalOutput_2020-04-06_w_2020-04-12_Global.csv_sum.csv'


DECLARE fileFull STRING DEFAULT 'FinalOutput_2020-04-06_w_2020-04-12_Global.csv';
...
DECLARE fileFull STRING DEFAULT 'FinalOutput_2020-04-06_w_2020-04-12_Global.csv';
DECLARE dS DATE DEFAULT '2020-04-06';
DECLARE dE DATE DEFAULT '2020-04-12';

CALL iata_sp.sp_process_X3(dS, dE, fileFull, 'gs://ext-iata-excl-data/2020/unzipped/');
select min(dt_of_issue) from iata.X3 where FILE_SOURCE like CONCAT('%',fileFull) and dt_of_issue > '2000-01-01'
...
DECLARE dS DATE DEFAULT '2020-03-30';
DECLARE dE DATE DEFAULT '2020-04-08';
