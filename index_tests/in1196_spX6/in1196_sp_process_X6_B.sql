--CREATE OR REPLACE PROCEDURE matching_sp.sp_process_X6(IN source_file STRING, IN max_days INT64)
BEGIN
  ...
  DECLARE source_file STRING DEFAULT 'FinalOutput_2020-04-13_w_2020-04-19_Global.csv';
