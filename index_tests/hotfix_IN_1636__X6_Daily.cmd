...
REM pushing 2 days into spX6 so possibly only need Day-2 partition (because kiwi is Day-2 at 7 am anyway) 
REM   but copy back to Day-3 in case
SET s=d-dat-digitalaircrafttransport
REM SET d=skytra-benchmark-devandtest
SET d=skytra-benchmark-uat
